	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CFileManagerServerView), CSize(100, 100), pContext))
	{
...
CFileManagerServerView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CFileManagerServerView* pView = DYNAMIC_DOWNCAST(CFileManagerServerView, pWnd);
	return pView;
}
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CFileManagerServerView* pView = GetRightPane();
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// 如果右窗格已创建而且是 CFileManagerServerView，
	// 则处理菜单命令...
	if (pView != NULL)
	{
		DWORD dwStyle = -1;
